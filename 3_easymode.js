...
/**
* <p>
* Assigns the <u>initialize and loadDarkModePreference</u> function to the window.onload event.
* This ensures the <u>initialize and loadDarkModePreference</u> function executes automatically when the webpage finishes loading.</p>
* <p>
* The window.onload event is triggered after all assets
* (e.g., HTML, CSS, JavaScript, images) are fully loaded.
* By using this assignment, the <u>initialize and loadDarkModePreference</u> function initializes
